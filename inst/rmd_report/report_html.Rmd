...
The total proportion of wells with water levels below normal or lower (i.e. 25th percentile or lower) on a given report date.
...
**Number of wells in each water level percentile class by date**
...
The total proportion of wells with water levels below normal or lower (i.e. 25th percentile or lower) on a given report date by hydraulic connectivity.
...
The total proportion of wells with water levels below normal or lower (i.e. 25th percentile or lower) on a given report date by aquifer type.
