...
To install the package from [GitHub](https://github.com/bcgov/bcgwlreports), use the [`remotes`](https://cran.r-project.org/package=remotes) package then the `fasstr` package:
...
To use the bcgwlreports functions, the package must first be called from the library:
